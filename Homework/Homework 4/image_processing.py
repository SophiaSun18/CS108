...
def polarize(image):
    ...
    # Calculate for the average pixel value of each color.
    ...
    ave = [red / num, green / num, blue / num]
    
    # Set up each pixel's new RGB value to either 255 or 0.
    ...
    for row_index in range(num_rows):
        for column_index in range(num_columns):
            ...
            image[row_index][column_index] = [rgb[0], rgb[1], rgb[2]]
